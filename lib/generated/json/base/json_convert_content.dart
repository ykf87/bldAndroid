...
import 'package:SDZ/generated/json/my_order_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
		switch (type) {
			...
			case MyOrderEntity:
				return myOrderEntityFromJson(data as MyOrderEntity, json) as T;
			case MyOrderList:
				return myOrderListFromJson(data as MyOrderList, json) as T;
			case RewardEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			...
			case MyOrderEntity:
				return myOrderEntityToJson(data as MyOrderEntity);
			case MyOrderList:
				return myOrderListToJson(data as MyOrderList);
			case RewardEntity:
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		if(type == (MyOrderEntity).toString()){
			return MyOrderEntity().fromJson(json);
		}
		if(type == (MyOrderList).toString()){
  ...
  //list is returned by type
	static M _getListChildType<M>(List data) {
		...
		if(<MyOrderEntity>[] is M){
			return data.map<MyOrderEntity>((e) => MyOrderEntity().fromJson(e)).toList() as M;
		}
		if(<MyOrderList>[] is M){
			return data.map<MyOrderList>((e) => MyOrderList().fromJson(e)).toList() as M;
		}
