...
class _LoginPageState extends BaseStatefulState<LoginPage> with SingleTickerProviderStateMixin {
  ...
  Widget inputWidget(String hintText,TextEditingController controller,{isPwd = false}){
    return  Container(
      height: 44,
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            contentPadding: const EdgeInsets.only(
                left: 16, top: 10, right: 0, bottom: 12),
            hintText: hintText,
            hintStyle: TextStyle(
                color: Colours.text_gray_c, fontSize: 15),
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: '请输入手机号码',
                hintStyle: TextStyle(fontSize: 15, color: Colours.color_A1A3AC, textBaseline: TextBaseline.alphabetic),
              ),
  ...
  Widget getLoginButtonWidget() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ButtonStyle(
          backgroundColor: MaterialStateProperty.all(_nextBtnEnable ? Colours.color_FF193C : Colours.color_gray_EFF0F2),
          elevation: MaterialStateProperty.all(0),
          shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
        ),
        child: Text(
          '登陆', style: TextStyle(fontSize: 16, color: _nextBtnEnable ? Colors.white : Colours.color_6A6E7E),
        ),
      ),
    );
  }
  ...
  void getInfo(){
    SPUtils.setUserToken('Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsIkF1dGhvciI6bnVsbH0..BaCVllxXkharXdL-GWgB6yfvXbHx9ZMA4njFSk8FVtU');
    ApiClient.instance.get(ApiUrl.getBLDBaseUrl()+ApiUrl.getGlobalConfig,  onSuccess: (data) {
  ...
  void toLogin() {
    ...
    ApiClient.instance.post(ApiUrl.getBLDBaseUrl()+ApiUrl.login, data: map, onSuccess: (data) {
