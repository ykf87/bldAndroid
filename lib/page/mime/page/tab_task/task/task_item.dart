  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: AssetImage(widget.entity.resType > 4
            ? "assets/images/integral_bg_waterfall_flow_1.png"
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "剩余可完成${widget.entity.leftCout()}次",
            style: TextStyle(
              color: Colors.white,
              fontSize: 14,
            ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  width: widget.entity.platform == 3?0:4,
                ),
                widget.entity.platform == 3
                    ? Text(
