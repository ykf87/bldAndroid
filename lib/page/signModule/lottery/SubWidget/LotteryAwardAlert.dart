...
class LotteryAwardAlert extends TransitionRoute {
  ...
  LotteryAwardAlert({required this.itemModel, required this.popBlock});
  LotteryItemModel? itemModel;
  VoidCallback? popBlock;
...
class GiftContentView extends StatefulWidget {
  const GiftContentView({required this.giftImg});
...
class HeroGiftView extends StatelessWidget {
  const HeroGiftView({required Key key, required this.isAlertStyle, required this.giftImg}) : super(key : key);
