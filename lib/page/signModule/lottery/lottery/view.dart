import 'package:SDZ/page/signModule/lottery/SubWidget/LotteryCircle.dart';
import 'package:SDZ/page/signModule/lottery/SubWidget/ScrollListView.dart';
import 'package:SDZ/page/signModule/lottery/lottery/rule.dart';
...
class LotteryPage extends StatelessWidget {
  final LotteryLogic logic = Get.put(LotteryLogic());
  final LotteryState state = Get.find<LotteryLogic>().state;
