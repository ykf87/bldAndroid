...
class Styles {
  ...
  static const TextStyle style_1A2F51_14 =
      TextStyle(color: Colours.color_1A2F51, fontSize: 14);
  static const TextStyle style_1A2F51_16 =
      TextStyle(color: Colours.color_1A2F51, fontSize: 16);
  static const TextStyle style_1A2F51_18 =
      TextStyle(color: Colours.color_1A2F51, fontSize: 18);

  ///---------------------------淡灰色字体区域-------------------------------
  static const TextStyle style_B8C0D4_11 =
  TextStyle(color: Colours.color_B8C0D4, fontSize: 11);
  static const TextStyle style_B8C0D4_13 =
      TextStyle(color: Colours.color_B8C0D4, fontSize: 13);
  static const TextStyle style_B8C0D4_14 =
      TextStyle(color: Colours.color_B8C0D4, fontSize: 14);
  ...
  static const TextStyle style_6A6969_14 =
      TextStyle(color: Colours.color_6A6969, fontSize: 14);
  static const TextStyle style_6A6969_16 =
      TextStyle(color: Colours.color_6A6969, fontSize: 16);
  ...
  static const TextStyle style_24CF5F_14 =
      TextStyle(color: Colours.color_24CF5F, fontSize: 14);


  ///---------------------------黄色、淡黄色字体区域-------------------------------
  static const TextStyle style_FE8C28_24_bold = TextStyle(
      color: Colours.color_FE8C28,
      fontSize: 24,
      fontWeight: FontWeight.w700);

  static const TextStyle style_FFAE2E_14 =
  TextStyle(color: Colours.color_FFAE2E, fontSize: 14);

  static const TextStyle style_FFAE2E_16 =
      TextStyle(color: Colours.color_FFAE2E, fontSize: 16);

  static const TextStyle style_FE8C28_11 =
  TextStyle(color: Colours.color_FE8C28, fontSize: 11 , height: 1.1);
}
