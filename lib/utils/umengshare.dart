...
class UMengShare {
  ...
  static const MethodChannel _channel =
      const MethodChannel('ugle.cn/UMengShare');
  ...
  static Future<dynamic> shareImage(
    ...
    shareToWeChat(WeChatShareImageModel(
      ...
      scene: platform == UMSharePlatform.WechatSession
          ? WeChatScene.SESSION
  ...
  static void sharedWeb( UMSharePlatform platform,
      UMShareMediaType type,
      String title,
      String desc,
      String thumb,
    ...
    var model = WeChatShareWebPageModel(
      ...
      scene: platform == UMSharePlatform.WechatTimeLine
          ? WeChatScene.TIMELINE
          : WeChatScene.SESSION,
    );
    shareToWeChat(model);
