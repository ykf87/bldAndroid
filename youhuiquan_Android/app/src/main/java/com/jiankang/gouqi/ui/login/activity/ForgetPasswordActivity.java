...
import static com.jiankang.gouqi.common.enums.OptTypeEnum.RESET_MONEYBAG_PASSWORD;
...
public class ForgetPasswordActivity extends BaseMvpActivity {
    ...
    public static void launch(Context context, boolean isPackage) {
        Intent intent = new Intent(context, com.jiankang.gouqi.ui.login.activity.ForgetPasswordActivity.class);
