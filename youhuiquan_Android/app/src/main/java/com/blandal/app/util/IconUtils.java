...
public class IconUtils {
    ...
    public static int getDrawableByReflect(String field) {
        field = "icon_"+field;
        int drawable = 0;
        // "cn.testreflect.R$drawable"
        String pkg = MyApplication.getContext().getPackageName();
        String clazz = pkg + ".R$mipmap";
        try {
     ...
     * 获取白天深色天气图标
     */
//    public static int getDrawableByReflect(String weather) {
//        int imageId;
//        switch (weather) {
//            case "100":
